...
var Liquibase = /** @class */ (function () {
    ...
    Liquibase.prototype.mergeParamsWithDefaults = function (params) {
        var defaults = tslib_1.__assign(tslib_1.__assign({}, postgresql_default_config_1.POSTGRESQL_DEFAULT_CONFIG), { liquibase: path_1.join(__dirname, '../bin/liquibase/liquibase') });
