...
var Liquibase = /** @class */ (function () {
    ...
    Liquibase.prototype.dropAll = function () {
        return this.run(LiquibaseCommands.CalculateCheckSum);
    };
    /**
    ...
    Liquibase.prototype.mergeParamsWithDefaults = function (params) {
        var defaults = __assign(__assign({}, POSTGRESQL_DEFAULT_CONFIG), { liquibase: join(__dirname, '../bin/liquibase/liquibase') });
