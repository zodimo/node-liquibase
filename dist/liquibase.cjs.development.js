...
var Liquibase = /*#__PURE__*/function () {
  ...
  _proto.run = function run(action, params) {
    ...
    var paramsFromLiquibasePropertyFile = this.loadParamsFromLiquibasePropertiesFileOnDemands(this.config.liquibasePropertiesFile);
...
//# sourceMappingURL=liquibase.cjs.development.js.map
